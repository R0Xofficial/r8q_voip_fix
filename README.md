...
The provided files contain C source code intended to be compiled as a *shim*.  
Their purpose is to resolve issues related to VoIP functionality on the supported systems.
